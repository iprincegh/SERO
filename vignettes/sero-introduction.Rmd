...
optimal_locations <- sero_optimal(
  data,
  max_locations = 3,
  accident_weight = 0.4,
...
precise_hotspots <- sero_hotspots(
  data$accident,
  risk_categories = c(1, 2),
...
accident_focused <- sero_optimal(
  data,
  max_locations = 5,
  accident_weight = 0.6,    # High weight on accident proximity
  population_weight = 0.15,
  road_weight = 0.1,
)

# Population-focused optimization
population_focused <- sero_optimal(
  data,
  max_locations = 5,
  accident_weight = 0.2,
  population_weight = 0.5,   # High weight on population coverage
  road_weight = 0.15,
)
